...
from diff_epr.kernels import deer_trace, deer_trace_oriented, spin_distance


def test_epr_basic() -> None:
...
def test_epr_differentiable() -> None:
    distances = jnp.array([30.0, 40.0])
    time = jnp.linspace(0, 2.0, 100)
...
def test_deer_dipolar_parity() -> None:
    """
...
def test_deer_trace_oriented() -> None:
    """
...
def test_deer_oriented_uses_theta_r1() -> None:
    """
...
def test_deer_oriented_magic_angle() -> None:
    """
...
def test_deer_oriented_differentiable_wrt_orientation() -> None:
    """
    ...
    def loss(orientation: jnp.ndarray) -> jnp.ndarray:
